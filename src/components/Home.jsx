...
const Home = () => {
    ...
    return (
        <div className="w-screen h-full py-10 max-w-[1200px] mx-auto  lg:px-0">
        <div className=" flex flex-col gap-y-5 items-start">
            ...
            />
            <button
                className="mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700"
                onClick={createPaste}
            >
